...
class RequestCollection
{
    ...
    public function appendRequest(string $space, object $request): RequestCollection {
    ...
    public function removeRequest(int $index): RequestCollection {
    ...
    public function phrase(): string {
        ...
        return json_encode($this->_requests);
