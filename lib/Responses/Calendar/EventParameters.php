...
class EventParameters extends EventCommonParameters
{
    ...
    public function recurrenceRule(): EventRecurrenceRuleParameters|null
    {
        if ($this->parameter('recurrenceRule')) {
            return new EventRecurrenceRuleParameters($this->parameter('recurrenceRule'));
        }
        return null;
    }
